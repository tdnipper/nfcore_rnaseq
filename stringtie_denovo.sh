...
podman run --rm \
    ...
    bash -c "
        ...
        stringtie --merge -p 12 -v -m 50 -T 1 -G /genomes/hybrid_annotated_fixed.filtered.gtf -o /stringtie/merged_transcriptome.gtf \$(find /stringtie/ -name '*_transcriptome.gtf' -type f)
    "